...
function BonusScanner:Debug( Message )
	...
	DEFAULT_CHAT_FRAME:AddMessage("Bonus-Scanner: "..Message, 0.5, 0.8, 1)
	end	
end
		...
		if BonusScanner.bonuses[bonus] then
			...
			for j, slot in BonusScanner.slots do 
				if BonusScanner.bonuses_details[bonus][slot] then
					...
					s = s..LIGHTYELLOW_FONT_COLOR_CODE..slot..HIGHLIGHT_FONT_COLOR_CODE..": "..BonusScanner.bonuses_details[bonus][slot]
				end
			end
			if BonusScanner.bonuses_details[bonus]["Set"] then
				...
				s = s..LIGHTYELLOW_FONT_COLOR_CODE.."Set"..HIGHLIGHT_FONT_COLOR_CODE..": "..BonusScanner.bonuses_details[bonus]["Set"]
				end
			s = s..")"
